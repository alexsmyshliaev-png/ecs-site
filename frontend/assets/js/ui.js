...
(function () {
  ...
  function initFab() {
    ...
    if (CFG.max) items.push({ label: "MAX", color: "#2787f5", href: CFG.max, icon: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 3C6.9 3 3 6.6 3 11c0 2.3 1.1 4.3 2.9 5.7L5 21l4.7-1.7c.7.2 1.5.3 2.3.3 5.1 0 9-3.6 9-8s-3.9-8-9-8Zm-3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Zm3 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Zm3 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3Z"/></svg>' });
