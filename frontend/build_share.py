...
Шрифт Inter теперь self-hosted (assets/fonts/*.woff2) и встраивается в
файл data-URI'ом — offline отображается корректно.
Что по-прежнему требует интернета у получателя (и не работает с
пересланного файла в любом случае): калькуляторы Финуслуг/polis812,
CRM-формы и виджет Битрикс24, Яндекс.Карты.
"""
import base64
import mimetypes
import os
